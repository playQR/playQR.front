...
import { CustomTextInput, CustomFileInput, CustomDateInput, CustomTimeInput } from '../common/inputs'; // Tailwind CSS에서 제공하는 Heroicons를 사용합니다.
    ...
    <div className='w-full bg-system-white p-4'>
      <Formik
        ...
        <Form>
          ...
          <CustomDateInput label='공연 일정을 알려주세요' name='showDate' type='text' initialVal = {initialVal.showDate}/>
